...
<link type="text/css" href="view/javascript/admin_theme/base5builder_impulsepro/ui/themes/ui-lightness/jquery-ui-1.8.20.custom-min.css" rel="stylesheet" />
  ...
  <style type="text/css">
    .sidebar-logo a:link{ color: #fff; decoration: none;}
	.sidebar-logo a:hover, a:focus { text-decoration: none; }
	.sidebar-logo h3 { font-family: Raleway,"Helvetica Neue",Helvetica,Arial,sans-serif;}
  </style>
</head>
...
<body>
	...
	<div class="container-fluid">
		...
		<div id="left-column">
			...
			<!--div class="sidebar copyright" style="margin-top: 100%;">
